...
@echo on
batchisp -device at90usb82 -hardware usb -operation erase f memory flash blankcheck loadbuffer "Arduino-usbserial-atmega16u2-Mega2560-Rev3.hex" program verify start reset 0
@echo off
if %errorlevel% NEQ 0 (
    goto R3FLASH
)
...
@echo on
batchisp -device atmega16u2 -hardware usb -operation erase f memory flash blankcheck loadbuffer "Arduino-usbserial-atmega16u2-Mega2560-Rev3.hex" program verify start reset 0
@echo off
if %errorlevel% NEQ 0 (
    echo %errorlevel%
